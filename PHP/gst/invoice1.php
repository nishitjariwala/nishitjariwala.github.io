...
<html lang="en">
  ...
  <body>
    ...
    <header class="clearfix">
      ...
      <div class="mn"><?php echo $owner['address'].", Gurarat "; ?></div>
        ...
        <div id="invoice" style="padding: 10px;">
          ...
          <div ><h3>Date: <?php echo date("d/m/yy"); ?></h3></div>
          <!-- <div ><h3>Date: 21/03/2020 </h3></div> -->
      ...
      <table border="1px solid black" cellspacing="0" cellpadding="0">
        <thead>
          <tr>
            ...
            <th class='bd1' id="heading_table">QTY.</th>
        ...
        <tr >
         ...
         <td style='color: black; border-top: 1px solid white; border-right: 1px solid white; border-left: 1px solid white;'></td>
            ...
            <td class="tt" style="color: black;"><?php echo $grand_total;?></td>
          </tr>
        </tfoot>
      </table>
    ...
    <p style="text-align: right;"><b><?php echo $owner['name'];?></b></p>
