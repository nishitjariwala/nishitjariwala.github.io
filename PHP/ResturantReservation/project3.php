...
<div class="w3-top">
  <div class="w3-bar w3-white w3-padding w3-card" style="letter-spacing:4px;">
    <a href="#home" class="w3-bar-item w3-button">lettuce eat</a>
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1600px;min-width:500px" id="home">
  <img class="w3-image" src="hotel.png" alt="Hamburger Catering" width="1600" height="500">
  <div class="w3-display-bottomleft w3-padding-large w3-opacity">
    <center><h1 class="w3-xxxlarge" style="color: Green; texy-align: center;">lettuce eat</h1></center>
  </div>
</header>
...
<div class="w3-content" style="max-width:1100px">
  ...
  <hr>
  <div class="w3-container w3-padding-64" id="booking">
    <h1>Contact</h1><br>
